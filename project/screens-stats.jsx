...
// ─── Weekly recap ────────────────────────────
function ScreenWeekly({ dense = false }) {
  const days = [
  ...
  return (
    <div style={{ padding: '8px 16px 24px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, paddingTop: 6 }}>
        ...
        <button style={{ width: 32, height: 32, borderRadius: 7, background: 'var(--bg-surface)', border: '1px solid var(--line)', color: 'var(--text-2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{
          ...
          {days.map((d, i) => {
            ...
            return (
              <div key={i} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
                <div style={{
                  width: '100%', height: h, background: c, borderRadius: 3,
                  position: 'relative',
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          {days.map((d, i) => (
            ...
            }}>{d.d}{d.n.toString().padStart(2,' ')}</div>
          ))}
        </div>
      </div>

      {/* macros donut + averages */}
      <PASection title="Moyennes hebdomadaires" code="kcal · macros">
        <div style={{
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Legend c="var(--accent)" l="Protéines" v="18%" sub="86g" />
            <Legend c="var(--accent-2)" l="Glucides" v="48%" sub="233g" />
            <Legend c="var(--warn)" l="Lipides" v="34%" sub="73g" />
          </div>
        </div>
      </PASection>
      ...
      <PASection title="Tendances · 7 jours" action={dense ? 'Réduire' : 'Détail'}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          <Trend l="Sel" v="4.6" u="g/j" trend="↑ 0.4g" status="warn"  data={[3.2, 4.1, 3.8, 4.4, 5.1, 4.8, 4.2]} />
          <Trend l="AGS" v="15.2" u="g/j" trend="↓ 1.1g" status="ok"   data={[16, 15, 17, 14, 16, 15, 14.7]} />
          <Trend l="Fibres" v="22" u="g/j" trend="↓ 8g cible" status="warn"  data={[18, 24, 22, 20, 26, 22, 18]} />
          <Trend l="NOVA" v="2.1" u="/4" trend="stable" status="ok"   data={[2.2, 2.0, 1.8, 2.1, 2.3, 1.9, 2.1]} />
          {dense && <>
            <Trend l="ω-6/ω-3" v="5.2" u=":1" trend="↑ 0.4" status="warn"  data={[4.8, 5.1, 5.4, 5.0, 6.0, 5.2, 6.4]} />
            <Trend l="Sucres" v="38" u="g/j" trend="↓ 4g" status="ok"   data={[42, 45, 38, 40, 36, 35, 42]} />
          </>}
        </div>
      </PASection>
      ...
      <PASection title="Top aliments" code="fréquence">
        <div style={{
          ...
          {[
            { n: 'Yaourt nature', c: 7, m: '7 / 7 j', nova: 1 },
            { n: 'Pain complet', c: 6, m: '6 / 7 j', nova: 2 },
            { n: 'Œuf entier', c: 5, m: '5 / 7 j', nova: 1 },
            { n: 'Pomme', c: 5, m: '5 / 7 j', nova: 1 },
            { n: 'Café noir', c: 7, m: '14× cette semaine', nova: 2 },
          ].map((a, i) => (
            <div key={i} style={{
      ...
      <PASection title="Standout" code="meilleur / pire">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          <Standout
            type="best"
            day="Mer · 08"
            name="Bowl saumon - quinoa - légumes"
            score="92"
            attrs={[['NOVA', '1.2'], ['ω-3', 'top'], ['Hansel', '3/3']]}
          />
          <Standout
            type="worst"
            day="Ven · 10"
            name="Pizza 4 fromages + soda"
            score="38"
            attrs={[['NOVA', '3.8'], ['AGS', '× 2.1'], ['Sel', '× 1.6']]}
          />
        </div>
      </PASection>

      {/* alerts scientifiques */}
...
// ─── Monthly recap ────────────────────────────
function ScreenMonthly({ dense = false }) {
  return (
    <div style={{ padding: '8px 16px 24px' }}>
      {/* segmented */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, paddingTop: 6 }}>
        ...
        <button style={{ padding: '6px 12px', background: 'var(--bg-surface)', border: '1px solid var(--line)', borderRadius: 7, color: 'var(--text-2)', fontFamily: 'var(--mono)', fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.08em', display: 'flex', alignItems: 'center', gap: 6 }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <div style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '0.12em' }}>Mai 2026 · J−12</div>
        <div style={{ fontSize: 22, fontWeight: 600, letterSpacing: '-0.02em', marginTop: 2 }}>Bilan mensuel</div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, position: 'relative' }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: 6 }}>vs avril 2026</div>
            ...
            {Array.from({length: 30}).map((_, i) => {
              ...
              return (
                <div key={i} style={{
                  ...
                  background: c, opacity: 0.18 + (score / 100) * 0.85,
                  position: 'relative',
      ...
      <PASection title="Indicateurs clés · 30 j">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          <BigTrend l="kcal / jour" v="1 928" prev="1 875" sub="+ 53" up data={[1900,1850,1980,2050,1920,1880,1990,2040,1960,2080,1920,1880]} c="var(--accent)" />
          <BigTrend l="Sel" v="4.4 g" prev="5.1 g" sub="− 0.7 g" data={[5.4,5.2,5.0,4.9,4.6,4.4,4.7,4.5,4.3,4.4,4.2,4.4]} c="var(--ok)" />
          <BigTrend l="ω-6 / ω-3" v="5.2:1" prev="6.8:1" sub="− 1.6" data={[7.0,6.5,6.2,5.8,5.5,5.4,5.0,5.1,4.9,5.2,5.0,5.2]} c="var(--accent-2)" />
          <BigTrend l="Fibres" v="24 g" prev="19 g" sub="+ 5 g" up data={[18,20,22,21,24,23,25,22,24,25,26,24]} c="var(--ok)" />
        </div>
      </PASection>
...
function Trend({ l, v, u, trend, status, data }) {
...
function BigTrend({ l, v, prev, sub, up, data, c }) {
  return (
    <div style={{
      background: 'var(--bg-surface)', border: '1px solid var(--line)',
...
function Standout({ type, day, name, score, attrs }) {
...
function ScreenHistory() {
  const items = [
    { d: 'Lun. 12 mai', i: [
      { t: '16:22', n: 'Pomme + amandes', k: 228, nova: 1, s: 'ok' },
      { t: '12:48', n: 'Salade quinoa-feta', k: 628, nova: 2, s: 'ok' },
      { t: '08:14', n: 'Tartines avocat + œuf', k: 412, nova: 2, s: 'ok' },
    ]},
    { d: 'Dim. 11 mai', i: [
      { t: '20:08', n: 'Pâtes carbonara maison', k: 720, nova: 2, s: 'warn' },
      { t: '13:02', n: 'Risotto champignons', k: 540, nova: 2, s: 'ok' },
      { t: '09:30', n: 'Granola maison + fruits rouges', k: 386, nova: 2, s: 'ok' },
    ]},
    { d: 'Sam. 10 mai', i: [
      { t: '19:55', n: 'Pizza 4 fromages', k: 880, nova: 4, s: 'alert' },
      { t: '12:30', n: 'Sandwich poulet crudités', k: 510, nova: 3, s: 'warn' },
    ]},
  ];
          ...
          <div style={{
            ...
            {day.i.map((m, mi) => (
              <div key={mi} style={{
                display: 'flex', alignItems: 'center', gap: 12,
                padding: '10px 12px',
                borderBottom: mi < day.i.length-1 ? '1px solid var(--line)' : 'none',
              }}>
...
Object.assign(window, { ScreenWeekly, ScreenMonthly, ScreenHistory });
