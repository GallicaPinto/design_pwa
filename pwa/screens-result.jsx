...
function ScreenResult({ back, dense = false }) {
  return (
    <div style={{ padding: '8px 16px 24px' }}>
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--line)', borderRadius: 16, overflow: 'hidden', marginBottom: 12 }}>
        <div style={{ height: 140, position: 'relative', background: 'radial-gradient(circle at 50% 50%, #5a4530, #1a120a)' }}>
          <div style={{
      ...
      <PASection title="Aliments détectés" code="6 · CIQUAL" action="+ ajouter">
        ...
        <div style={{
          ...
          borderRadius: 8, fontSize: 11, color: 'var(--warn)', lineHeight: 1.4,
      ...
      <PASection title="Classification NOVA" code="Monteiro · OMS">
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--line)', borderRadius: 12, padding: 14 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 4 }}>
            {[
              { c: 'var(--ok)', l: '1 · Bruts' },
              { c: 'var(--accent-2)', l: '2 · Culinaire' },
              { c: 'var(--warn)', l: '3 · Transformés' },
              { c: 'var(--alert)', l: '4 · Ultra-tr.' },
            ].map((g, i) => (
      ...
      <PASection title="Profil ω-6 / ω-3" code="ANSES">
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--line)', borderRadius: 12, padding: 14 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, height: 60, marginBottom: 10, position: 'relative' }}>
            ...
            <OmegaBar label="AL" v="1.42" u="g" h={42} c="var(--accent-2)" />
            <OmegaBar label="ALA" v="0.38" u="g" h={20} c="var(--accent)" />
            <OmegaBar label="EPA" v="0.02" u="g" h={3} c="var(--accent)" muted />
            <OmegaBar label="DHA" v="0.04" u="g" h={4} c="var(--accent)" muted />
            <div style={{ flex: 1 }} />
      ...
      <PASection title="Règles Hansel · par aliment" code="3 / 3">
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--line)', borderRadius: 12, padding: '12px 14px' }}>
          {[
      ...
      {dense && (
        <PASection title="Vitamines & minéraux" code="22 nutriments">
          <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--line)', borderRadius: 12, padding: 12 }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8 }}>
              {[
                { l: 'B9', v: '142', u: 'µg', pct: 71 },
      ...
      {/* warnings */}
      <div style={{
        padding: '12px 14px', background: 'var(--bg-canvas)', border: '1px dashed var(--line-strong)',
        borderRadius: 10, marginTop: 12, fontSize: 11, color: 'var(--text-3)', lineHeight: 1.5,
      }}>
...
function FoodRow({ name, ciqual, conf, qty, kcal, nova, ok, warn, last, edit }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', borderBottom: last ? 'none' : '1px solid var(--line)' }}>
      ...
      <div style={{ textAlign: 'right' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 2, justifyContent: 'flex-end' }}>
          <input style={{
            width: 36, padding: '2px 4px', background: 'var(--bg-canvas)',
            border: '1px solid var(--line-strong)', borderRadius: 4,
            color: 'var(--text-1)', fontFamily: 'var(--mono)', fontSize: 12, textAlign: 'right',
          }} defaultValue={qty} />
...
function OmegaBar({ label, v, u, h, c, muted }) {
  return (
